...
import { googleSheetsService } from '../../admin/js/sync.js'; // Nuovo import
...
const onAuthenticationSuccess = () => {
    ...
    // Avvia sincronizzazione dopo l'autenticazione
    syncDataFromSheets();
};
...
const setupPeriodicSync = () => {
	...
	setInterval(() => {
			...
			syncDataToSheets();
			syncDataFromSheets(); // Aggiungo anche il recupero dati
	}, 1 * 60 * 1000);
};
